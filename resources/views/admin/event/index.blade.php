        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('admin.event.destroy', $event->id_event) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus event ini? Semua kategori pemilihan akan ikut terhapus!')">
                        @csrf
                        @method('DELETE')
