...
<div class="page-header">
    ...
    <div class="header-actions">
        ...
        <a href="{{ route('admin.event.trash') }}" class="btn-secondary">🗑️ Trash</a>
        @endif
    ...
    <table>
        ...
        <tbody id="eventTableBody">
            ...
            <tr class="event-row" 
                ...
                <td>
                    <a href="{{ route('admin.event.show', $event->id_event) }}" class="btn-action btn-view">Detail</a>
                    
                    @if($admin->isSuperAdmin() || $admin->isAdmin())
                    <a href="{{ route('admin.event.edit', $event->id_event) }}" class="btn-action btn-edit">Edit</a>
                    @endif
                    
                    @if($admin->isSuperAdmin())
                    <form action="{{ route('admin.event.destroy', $event->id_event) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus event ini? Data akan masuk ke Trash.')">
                        @csrf
                        @method('DELETE')
