...
@section('title', 'Pilih Event - Kandidat')
...
<div class="page-header">
    ...
    <div class="header-actions">
        ...
        <a href="{{ route('admin.kandidat.trash') }}" class="btn-secondary">🗑️ Trash</a>
        @endif
    </div>
</div>
    ...
    <table>
        ...
        <tbody id="eventTableBody">
            ...
            <tr class="event-row" 
                ...
                onclick="window.location.href='{{ route('admin.kandidat.selectKategori', $event->id_event) }}'">
...
<div class="table-container">
    <div class="empty-state">
        ...
        <p>Silakan hubungi admin untuk membuat event pemilihan baru</p>
    </div>
</div>
@endif
